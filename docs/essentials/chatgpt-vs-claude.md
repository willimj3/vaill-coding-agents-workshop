...
**If you are just starting:** Start with whichever one you already have. The techniques in [Chatbots Done Right](chatbots.md) and [Prompt Engineering](prompting.md) work with both. Do not let the tool choice delay you -- the habits matter more than the platform.
