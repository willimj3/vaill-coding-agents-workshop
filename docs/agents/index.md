...
-   **:material-map-outline: The Agent Landscape**
    ...
    [:octicons-arrow-right-24: See the landscape](landscape.md)

-   **:material-star-outline: Why Claude Code?**
...
-   **:material-briefcase-outline: What Agents Can Do**

    ---

    Concrete, law-specific examples of agent capabilities — from contract analysis to course design — described in plain language.

    [:octicons-arrow-right-24: See the possibilities](capabilities.md)

-   **:material-alert-outline: Limitations & Risks**
    ...
    [:octicons-arrow-right-24: Know the boundaries](limitations.md)
